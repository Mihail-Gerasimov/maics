...
<head>
  ...
  <link rel="shortcut icon" href="https://ldigital.ru/img/favicon.ico">
	<title><?php echo $page_title; ?></title>

  <!-- webpack css run with use_dev var -->
  <?php if (WCMS_DEV) echo '<link rel="stylesheet" href="' . WCMS_DEV_PORT . '/lcorp/assets/css/main.css">';
        else echo '<link rel="stylesheet" href="assets/css/main.css?ver=todofixit13241">';?>
  <!-- black theme -->
  <?php if ($_SESSION['theme'] == 'black') {
          if (WCMS_DEV) echo '<link rel="stylesheet" href="' . WCMS_DEV_PORT . '/lcorp/assets/css/black.css">';
